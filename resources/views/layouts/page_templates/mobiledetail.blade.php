<div class="mobile">
    <div class="card pub_image rounded-0">
        ...
        <div class="card-body">
            ...
            <div class="comments col-12" style="vertical-align: middle;display: flex;align-items: baseline;">
                <!-- Form to write comments in the image -->

                <input type="hidden" name="_token" value="Pc5xI3yObHlWgcmv4uLWyFrdXvjSRoCghwrI8ECZ"> <input type="hidden" name="image_id" value="28">
                <div class="form-group mb-2 bmd-form-group" style="width: inherit;">
                    <!-- Input with the user nick in the placeholder -->
                    <input type="text" class="form-control" id="comment" name="content" placeholder="Add a comment as chatinity..." required="">
                </div>
                <button type="submit" class="ml-auto rounded-pill btn btn-outline-primary">Post</button>
            </div>
        </div>
    </div>
</div>