    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Insert your credentials') }}</p>
            ...
            <div class="bmd-form-group{{ $errors->has('nick') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                ...
                <input type="text" name="nick" class="form-control" placeholder="{{ __('Nickname...') }}" value="{{ old('nick') }}" required>
              </div>
              @if ($errors->has('nick'))
              <div id="nick-error" class="error text-danger pl-3" for="nick" style="display: block;">
